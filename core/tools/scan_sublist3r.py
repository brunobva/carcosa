...
subdomains = {}
rand = str(uuid.uuid1())
container_name = target + '-' + 'sublist3r' + rand
output = 'sublist3r-' + rand + '.txt'
...
def exec_docker():
    subprocess.check_output(
        'docker run --rm --name ' + container_name + ' -v ' + dir + '/../../docker/data/' + target + '/temp:/data kali-carcosa:1.0 sublist3r -d ' + domain + ' -o /data/' + output + ' || true',
        shell=True)
